#include <math.h>
// Linkage Length
const float L1 = 238.0; // Major Link 1
const float L4 = 238.0; // Major Link 2
const float L5 = 66.0; // the distance between assist arm and rocker lock point
const float L3 = 238.0; // assist arm
const float L2 = 68.0; // Major Link 2 drive arm
